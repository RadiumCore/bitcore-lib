# Browser Builds
Radium and most official submodules work in the browser, thanks to [browserify](http://browserify.org/) (some modules are not fully compatible with web browsers).
...
<head>
  <meta charset="utf-8">
  <script src="bower_components/radium/radium.min.js"></script>
...
```sh
browserify --require ./index.js:radium | uglifyjs > radium.min.js
```
