# Radium Address
Represents a radium address. Addresses are the most popular way to make radium transactions. See [the official Bitcoin Wiki](https://en.bitcoin.it/wiki/Address) for technical background information.

## Instantiate an Address
To be able to receive radiums an address is needed, but in order to spend them a private key is necessary. Please take a look at the [`PrivateKey`](privatekey.md) docs for more information about exporting and saving a key.  
...
The errors are listed in the generated file in the [errors folder](https://github.com/RadiumCore/radium-lib/tree/master/lib/errors). There's a structure to errors defined in the [spec.js file](https://github.com/bitpay/RadiumCore/radium-lib/master/lib/errors/spec.js).
