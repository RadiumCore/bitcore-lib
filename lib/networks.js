 ...
 * numbers for each radium network. Currently only supporting "livenet"
...
addNetwork({
  ...
  xpubkey: 0x0473aaa1,
  xprivkey: 0x04734477,
  networkMagic: 0x2a7ccbab,
  port: 27913,
  dnsSeeds: [
    'us.radiumcore.org',
    'eu.radiumcore.org',
    'useast.projectradium.org',
    'asia.projectradium.org',
    'eu.projectradium.org'
  ]
});
