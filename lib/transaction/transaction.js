...
/**
 * Retrieve a hexa string that can be used with radiumd's CLI interface
 ...
 * * `disableMoreOutputThanInput`: disable checking if the transaction spends more radiums than the sum of the input amounts
 * @return {string}
 */
...
Transaction.prototype.checkedSerialize = function(opts) {
  ...
  if (serializationError) {
    serializationError.message += ' - For more information please see: ' +
      'https://radium.io/api/lib/transaction#serialization-checks';
 ...
 *
 * Can receive, as output information, the output of radiumd's `listunspent` command,
 * and a slightly fancier format recognized by radium:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a radium Address object. The
 * same is true for `script`, which can be a string or a radium Script.
 *
 ...
 *
 * // From a pay to public key hash output from radiumd's listunspent
 ...
 *
 * @see {https://github.com/radium/bips/blob/master/bip-0069.mediawiki}
 * @return {Transaction} this
 */
 ...
 * CheckTransaction in radium core.
 */
...
/**
 * Analogous to radiumd's IsCoinBase function in transaction.h
 */
