...
var HDPrivateKey = radium.HDPrivateKey;
var HDPublicKey = radium.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = radium.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(radium.crypto.BN.prototype, 'toBuffer', function(args) {
      ...
      sandbox.spy(radium.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      radium.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = radium.PublicKey.fromPoint;
      radium.PublicKey.fromPoint = function() {
        radium.PublicKey.fromPoint = unstubbed;
