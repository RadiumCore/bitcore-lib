...
var BufferUtil = radium.util.buffer;
var Script = radium.Script;
var Networks = radium.Networks;
var Opcode = radium.Opcode;
var PublicKey = radium.PublicKey;
var Address = radium.Address;
...
describe('Script', function() {
  ...
  describe('#isPublicKeyIn', function() {
    it('correctly identify scriptSig as a public key in', function() {
      ...
      var script = radium.Script.fromBuffer(scriptBuffer);
  ...
  describe('#isPushOnly', function() {
    it('should know these scripts are or aren\'t push only', function() {
      ...
      // like radiumd, we regard OP_RESERVED as being "push only"
  ...
  describe('#buildPublicKeyHashOut', function() {
    it('should create script from livenet address', function() {
      var address = Address.fromString('Xyiaj9zib9JRWVvqDzVTdcRARrwdvkZso5');
      var s = Script.buildPublicKeyHashOut(address);
      should.exist(s);
      s.toString().should.equal('OP_DUP OP_HASH160 20 0xfc9f1da68e6f8d9437d973355f1c46cb4169f141 OP_EQUALVERIFY OP_CHECKSIG');
      s.isPublicKeyHashOut().should.equal(true);
      s.toAddress().toString().should.equal('Xyiaj9zib9JRWVvqDzVTdcRARrwdvkZso5');
    });
  ...
  describe('#buildScriptHashOut', function() {
    ...
    it('inherits network property from other script', function() {
      var s1 = new Script.fromAddress(new Address('XrYaPekCEr8rwS2fDdxQjwdo7sgNQW45Nk'));
  ...
  describe('toAddress', function() {
    ...
    it('for a P2PKH address', function() {
      var stringAddress = 'Xyiaj9zib9JRWVvqDzVTdcRARrwdvkZso5';
    ...
    it('works for p2pkh output', function() {
      ...
      script.toAddress().toString().should.equal('XbCg7cwTyG3qevDK9QRTxWsYJfkPKftbZj');
    });
    it('works for p2pkh input', function() {
      ...
      s2.toAddress().toString().should.equal('XsG4sQzmXY9PERcuhaNwpsNU3yMff3k9nS');
    });
  ...
  describe('#getSignatureOperationsCount', function() {
    // comes from radiumd src/test/sigopcount_tests
    ...
    it('should handle P2SH-multisig-in scripts from utility', function() {
      ...
      var signature = radium.crypto.Signature.fromString('30060201FF0201FF');
